...
from utils.utils import compute_init, compute_cleanup, print0, get_base_dir, autodetect_device_type, download_file_with_lock
from tokenizer.tokenizer import HuggingFaceTokenizer
from utils.checkpoint_manager import load_model
from model.core_eval import evaluate_task
