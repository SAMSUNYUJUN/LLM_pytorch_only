...
from app.modules.model.core_eval import evaluate_task
...
def place_eval_bundle(file_path):
    ...
    eval_bundle_dir = os.path.join(base_dir, "data", "eval_bundle")
...
def main():
    ...
    if ddp_rank == 0:
        base_dir = get_base_dir()
        output_csv_path = os.path.join(base_dir, "data", "base_eval", f"{model_slug}.csv")
